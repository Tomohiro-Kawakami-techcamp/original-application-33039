...
### 2 課題解決
|:--:|:--:|:--:|
|視点|ユーザーストーリーから考える課題|解決策|
|:---|:---|:---|
|オーナー|どのくらいの人が利用しているのか知りたいという課題|管理機能をつける|
|オーナー|どういった評判なのかわからないという課題|お客さんにコメントしてもらう機能をつけ、オーナー側にそれを閲覧できる機能をつける|
|お客さん|単なるショップではつまらないという課題|オーナーがサービス投稿できるようにし、お客さん側は対象に当てはまる場合、それに申し込めるようにする。|
